...
IndexTickerList=pd.read_excel(r'F:\401K\1. 401K & ESOP\User - Karsten\401k-ESOP-Canada\Fund Performance Review\Scraping\Ticker lists\2022.10.31 Tickers.xlsx',sheet_name='CapFunds', engine='openpyxl')
...
Data_df_V.to_csv(csv_outputpath + '\\CapFundsData.csv')
