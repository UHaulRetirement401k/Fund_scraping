...
s=Service(r'C:\Users\1263654\Desktop\chromedriver.exe')
driver = webdriver.Chrome(service=s)#,options=chrome_options)

IndexTickerList=pd.read_excel(r'F:\401K\1. 401K & ESOP\User - Karsten\401k-ESOP-Canada\Fund Performance Review\Scraping\Ticker lists\2022.10.31 Tickers.xlsx',sheet_name='TargetFunds', engine='openpyxl')
...
for tick in TickerList:
    ...
    while attempts < 3:
        ...
        try:
            ...
            stdev_3 = driver.find_element("xpath",stdev).get_attribute('innerHTML') 
            MS_date_3 = driver.find_element("xpath",MS_date).get_attribute('innerHTML') 
            ...
            stdev_5 = driver.find_element("xpath",stdev).get_attribute('innerHTML') 
            ...
            stdev_10 = driver.find_element("xpath",stdev).get_attribute('innerHTML') 
...
Data_df_V.to_csv(csv_outputpath + '\\TargetFundsData.csv')
